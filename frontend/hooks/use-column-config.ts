...
export const DEFAULT_COLUMNS: ColumnConfig[] = [
  ...
  { id: "reach_multiple", label: "觸及倍數", visible: true, width: 90, order: 5 },
  { id: "likes", label: "讚", visible: true, width: 80, order: 6 },
  { id: "replies", label: "回覆", visible: true, width: 80, order: 7 },
  { id: "reposts", label: "轉發", visible: true, width: 80, order: 8 },
  { id: "quotes", label: "引用", visible: true, width: 80, order: 9 },
  { id: "engagement_rate", label: "互動率", visible: true, width: 70, order: 10 },
  { id: "reply_rate", label: "回覆率", visible: false, width: 70, order: 11 },
  { id: "repost_rate", label: "轉發率", visible: false, width: 70, order: 12 },
  { id: "quote_rate", label: "引用率", visible: false, width: 70, order: 13 },
  { id: "virality_score", label: "傳播力", visible: false, width: 70, order: 14 },
];
